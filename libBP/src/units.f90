...
! Forces
    ...
    Call AddUnit("EVANG", 6.241496D8)            ! ev/ang
    Call AddUnit("RYBOHR", 4.49383D9)            ! ry/bohr
    !Call AddUnit("RYBOHR", 4.11936139295036D-8)
    !Call AddUnit("EVANG", 1.602176568D-9)
! Forces
    Call AddUnit("MS-2", 1.0D0)                     ! M/s^2
    Call AddUnit("ANGPS-2", 1.0D-14)                     ! Angstrom/Picos^2
! Velocity
    Call AddUnit("MS-1", 1.0D0)                     ! M/s
    Call AddUnit("KPH", 3.6D0)                      ! KPH
    Call AddUnit("MPH", 2.23694D0)                      ! KPH
